...
public class NoteAppWidget extends AppWidgetProvider {
    ...
    public static final String CHANGE_IMAGE = "com.example.biji.action.CHANGE_IMAGE";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        mRemoteViews = new RemoteViews(context.getPackageName(), R.layout.note_app_widget);
        ...
        mComponentName = new ComponentName(context, NoteAppWidget.class);
